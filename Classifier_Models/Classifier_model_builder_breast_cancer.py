...
# Saving the model
pickle.dump(nb_classifier, open('res/breast-cancer_disease_classifier_NB.pkl', 'wb'))
pickle.dump(knn_classifier, open('res/breast-cancer_disease_classifier_KNN.pkl', 'wb'))
pickle.dump(dt_classifier, open('res/breast-cancer_disease_classifier_DT.pkl', 'wb'))
pickle.dump(lr_classifier, open('res/breast-cancer_disease_classifier_LR.pkl', 'wb'))
pickle.dump(rf_classifier, open('res/breast-cancer_disease_classifier_RF.pkl', 'wb'))
